...
LIVECELL_CLASSES = [
    "background", "A172", "BT474", "BV-2", "Huh7", "MCF7", "SH-SHY5Y", "SkBr3", "SK-OV-3"
]
LIVECELL_CLASSES_INV = [
    "background", "MCF7", "SH-SHY5Y", "SkBr3", "SK-OV-3", "A172", "BT474", "BV-2", "Huh7"
]
...
class StreamSegMetrics(_StreamMetrics):
    ...
    """
    def __init__(self, n_classes, opt):
        ...
        if dataset == 'voc':
            ...
            if "inv" in opt.task:
                self.CLASSES = LIVECELL_CLASSES_INV
            else:
                self.CLASSES = LIVECELL_CLASSES
        elif dataset == 'glas':
            self.CLASSES = GLAS_CLASSES
        else:
            NotImplementedError
