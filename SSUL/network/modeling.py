...
from ._deeplab import DeepLabHead, DeepLabHeadV3Plus, DeepLabV3, DeepLabV3withDetector
...
def _segm_resnet(name, backbone_name, num_classes, output_stride, pretrained_backbone, bn_freeze):
    ...
    if name=='deeplabv3_yolov4':
        return_layers = {'layer4': 'out'}
        classifier = DeepLabHead(inplanes , num_classes, aspp_dilate)
        backbone = IntermediateLayerGetter(backbone, return_layers=return_layers)
        detector = Yolov4(None, n_classes=1) # class agnostic
        model = DeepLabV3withDetector(backbone, classifier, detector, bn_freeze)
        return model
...
def deeplabv3_resnet101_yolov4(num_classes=21, output_stride=8, pretrained_backbone=True, bn_freeze=False):
    """Constructs a DeepLabV3 model with a ResNet-101 backbone.
    ...
    Args:
        ...
        pretrained_backbone (bool): If True, use the pretrained backbone.
    """
    return _load_model('deeplabv3_yolov4', 'resnet101', num_classes, output_stride=output_stride, 
                       pretrained_backbone=pretrained_backbone, bn_freeze=bn_freeze)
